function periodic_square_NDJ(D0_value,J0_value,seed)
close all
tic
...
for j=1:NN
    ...
    %Time step
    [Nnew(i,j),Dnew(i,j),Jnew(i,j),Inew(i,j)]=ndj_equations(Ninit(i,j),Dinit(i,j),Jinit(i,j),Iinit(i,j),Dext,Jext,N_D_I_ext,N_J_I_ext);
...
save(strcat('control300_D0_',num2str(D0),'_J0_',num2str(J0),'_t',num2str(seed),'.mat'),'N','D','I','J','T','kTD','kTJ','kC','ldf','N0','D0','J0','I0')
toc
end