function square_fn(NN,r,beta,seed)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%global NN TMAX
...
filename=strcat('square_beta',num2str(beta),'_r',num2str(r),'_dt',num2str(dt),'_TMAX',num2str(TMAX),'_T',num2str(seed),'.mat');
save(fullfile(cd,'neighborhoods',filename),'LEUP');
end